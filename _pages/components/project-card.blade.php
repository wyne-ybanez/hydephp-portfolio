<div data-aos="fade-in">
    <a href="{{ $link ?? '#' }}" target="_blank" class="w-full block rounded-md dark:border border">
        <div class="relative overflow-hidden rounded-md">
            <div class="h-[200px] md:h-72 object-cover">
                <img src="{{ $imgUrl ?? '#' }}" alt="portfolio"
                    class="rounded-md transform hover:scale-105 transition duration-1000 ease-out object-cover h-full w-full" />
            </div>
        </div>
    </a>
    <h3
