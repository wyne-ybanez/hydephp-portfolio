        ...
        <div class="mx-auto prose dark:prose-invert">
            <a href="#app" aria-label="Go to top of page" class="float-right">
                <button title="Scroll to top">
                    <svg width="1.5rem" height="1.5rem" role="presentation" class="fill-current text-gray-500 hover:text-black h-6 w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
