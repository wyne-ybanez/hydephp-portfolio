...
@section('content')
    ...
    <div class="antialiased">
        <h1 class="text-5xl md:text-9xl font-base text-center md:text-left dark:text-white" data-aos="fade-right">
            Contact
        </h1>
    </div>
    ...
    <div class="
          ...
          md:border
          relative shadow-xl
          py-10 px-4 md:p-10 lg:p-20 -mt-[1.38rem]
        "
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="md:ml-4">
                ...
                <div class="social-icons flex flex-row space-x-2">
                    <a href="{{ config('data.social_links.instagram') }}"
                        ...
                        <svg width="24" height="24"
                            class="dark:hover:text-gray-400 hover:text-blue-500 dark:text-zinc-300" viewBox="0 0 24 24"
