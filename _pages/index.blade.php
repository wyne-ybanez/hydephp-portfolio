...
<body id="app" class="flex flex-col min-h-screen overflow-x-hidden dark:bg-black dark:text-white"
    ...
    <div id="homepage" class="mx-auto max-w-[75rem] md:mx-16 lg:mx-auto">
        <div class="mx-auto md:mx-28">
            ...
            <div class="block overflow-hidden mx-auto xl:mx-[10rem]">
                <div class="flex flex-col w-full justify-center md:justify-start items-center md:items-start">
                    ...
                    <h2
                        class="animate fade-in delay-600 flex flex-row md:justify-start text-5xl md:text-7xl lg:text-8xl font-light text-zinc-700 dark:text-gray-200 my-5 lg:my-8">
                        <div
                    ...
                    <h2
                        class="animate fade-in delay-900 flex flex-row md:justify-start text-5xl md:text-7xl lg:text-8xl font-light text-zinc-700 dark:text-gray-200 my-5 lg:my-8">
                        <div
        ...
        <div class="-mt-40 md:mt-[5.5rem]">
            <div
                ...
                <h1 class="text-5xl md:text-9xl max-w-lg font-light text-zinc-900 mt-20 mb-14 md:mb-10 md:my-0 md:text-zinc-200 dark:text-gray-400 text-center"
                    data-aos="fade-right">
                    Favourite Projects
                </h1>
