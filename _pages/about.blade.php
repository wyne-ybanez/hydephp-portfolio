...
@section('content')
    ...
    <div class="-mt-4">
        <div class="text-container md:pt-20 pt-10 animate fade-in delay-600">
            <p
    ...
    <div class="pt-20 grid grid-cols-1 md:grid-cols-3 mx-auto gap-y-10 md:gap-y-20 gap-x-20">
        ...
        <div class="animate fade-left delay-600 col-span-1 md:col-span-2 text-lg font-light dark:text-white">
            <p class="mb-4">
                I've been coding professionally for 3 years now, creating websites for businesses in a
            ...
            <p class="mb-4">
                From a humanities degree to technical diplomas, my background bounces between
